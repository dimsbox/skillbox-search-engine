...
public record SearchStarter(SiteRepository siteRepository, SearchService searchService) {
    ...
    public List<SearchDTO> getSearchFromOneSite(String text, String url, int start, int limit) {
        ...
        sites.add(site);
        return searchService.createSearchDTOList(foundLemmaList, textLemmaList, start, limit, sites);
    }
    ...
    public List<SearchDTO> getFullSearch(String text, int start, int limit) {
        ...
        for (LemmaModel l : foundLemmaList) {
            searchData = searchService.createSearchDTOList(foundLemmaList, textLemmaList, start, limit, siteList);
